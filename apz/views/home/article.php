...
<head>
  ...
  <link href="http://localhost:8080/css/bootstrap.css" rel='stylesheet' type='text/css' />
  ...
  <!----webfonts---->
    ...
    <!--end slider -->
    <!--script-->
<script type="text/javascript" src="http://localhost:8080/js/move-top.js"></script>
<script type="text/javascript" src="http://localhost:8080/js/easing.js"></script>
<!--/script-->
...
<div class="header">  
   <div class="container">
      <div class="logo">
        <a href="index.html"><img src="http://localhost:8080/images/logo.jpg" title="" /></a>
      </div>
       <!---start-top-nav---->
       <div class="top-menu">
         <div class="search">
       ...
       <div class="col-md-8 content-main">
         <div class="content-grid">          
           <div class="content-grid-info">
             <img src="http://localhost:8080/images/post1.jpg" alt=""/>
             <div class="post-info">
           ...
           <div class="content-grid-info">
             <img src="http://localhost:8080/images/post2.jpg" alt=""/>
             <div class="post-info">
             <h4><a href="single.html">Lorem ipsum dolor sit amet</a>  July 30, 2014 / 27 Comments</h4>
             <p>Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis.</p>
             <a href="single.html"><span></span>READ MORE</a>
           ...
           <div class="content-grid-info">
             <img src="http://localhost:8080/images/post3.jpg" alt=""/>
             <div class="post-info">
             <h4><a href="single.html">Lorem ipsum dolor sit amet</a>  July 30, 2014 / 27 Comments</h4>
             <p>Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis.</p>
             <a href="single.html"><span></span>READ MORE</a>
